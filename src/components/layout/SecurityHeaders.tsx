...
export const SecurityHeaders = () => {
  useEffect(() => {
    ...
    const supabaseHost = `${import.meta.env.VITE_SUPABASE_PROJECT_ID}.supabase.co`;
    meta.content = `default-src 'self'; img-src 'self' data: https: blob:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-eval' https://www.google.com https://www.gstatic.com; connect-src 'self' https://${supabaseHost} https://api.openai.com wss://${supabaseHost} https://www.google.com; frame-src https://www.google.com https://www.recaptcha.net; frame-ancestors 'none'; object-src 'none'; base-uri 'self';`;
