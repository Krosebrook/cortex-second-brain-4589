...
export const SecurityHeaders = () => {
  useEffect(() => {
    ...
    meta.content = "default-src 'self'; img-src 'self' data: https: blob:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-eval' https://www.google.com https://www.gstatic.com; connect-src 'self' https://gcqfqzhgludrzkfajljp.supabase.co https://api.openai.com wss://gcqfqzhgludrzkfajljp.supabase.co https://www.google.com; frame-src https://www.google.com https://www.recaptcha.net; frame-ancestors 'none'; object-src 'none'; base-uri 'self';";
